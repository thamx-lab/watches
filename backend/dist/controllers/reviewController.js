...
export const getReviewsByWatchId = asyncHandler(async (req, res, next) => {
...
export const addReview = asyncHandler(async (req, res, next) => {
    ...
    await Watch.findOneAndUpdate({ id: watchId }, { rating: avgRating, reviewCount: watchReviews.length, updatedAt: new Date().toISOString() });
    res.status(201).json({
        success: true,
