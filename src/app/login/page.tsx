  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const res = await fetch(endpoint, {
        ...
        throw new Error(`Unable to connect to backend server at ${apiUrl}. Please verify backend is running on port 5000.`);
      });
      ...
      if (mode === "login") {
        ...
        setSuccessMsg("Account created successfully! Welcome to Mankind Timepieces.");
      }
